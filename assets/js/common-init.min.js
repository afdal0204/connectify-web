...
$(window).resize(function () {
    var e = $(this); 1024 <= e.width() && ($("html").addClass("minimenu"),
        $(".logo-full").hide(),
        $(".logo-abbr").show(),
        $("#menu-mini-button").hide(),
        $("#menu-expend-button").show()), 1600 < e.width() && ($("html").removeClass("minimenu"),
            $(".logo-full").show(), $(".logo-abbr").hide(),
    ...
    $(document).ready(function () {
        ...
        $("#menu-mini-button").on("click", function () {
            $("#menu-mini-button").hide(),
                ...
                $("html").addClass("minimenu"), localStorage.setItem("nexel-classic-dashboard-menu-mini-theme", "menu-mini-theme")
        }),
            $("#menu-expend-button").on("click", function () {
                $("#menu-expend-button").hide(),
                    $("#menu-mini-button").show(),
                    $("html").removeClass("minimenu"), localStorage.setItem("nexel-classic-dashboard-menu-mini-theme", "menu-expend-theme")
            })
    }),
    ...
    $(document).ready(function () {
        var e = {
            init: function () { this.initComponent() }, initComponent: function () {
                $(document).on("click", "[data-bs-toggle=refresh]", function (e) {
                    e.preventDefault(); var n, t = $(this).closest(".card");
                    $(t).hasClass("card-loading") || (n = $(t).find(".custom-card-action"),
                        e = '<div class="card-loader"><div class="spinner-border ' + ($(this).attr("data-spinner-class") ?
                            $(this).attr("data-spinner-class") : "text-primary") + '"></div></div>',
                        $(t).addClass("card-loading"), (0 !== $(n).length ? $(n) :
                    ...
                    var n = $(this).closest(".card"),
                        t = $(n).find(".custom-card-action"), a = "card-expand";
                    0 !== $(t).length && (e = $(n).offset().top, $(t).offset().top),
                        $("body").hasClass(a) && $(n).hasClass(a) ?
                            ($("body, .card").removeClass(a), $(".card").removeAttr("style"),
                                $(t).removeAttr("style")) : ($("body").addClass(a),
                                    $(this).closest(".card").addClass(a)),
                        $(window).trigger("resize")
                }), $(document).on("click", "[data-bs-toggle=remove]", function (e) {
                    e.preventDefault(),
                        $(this).tooltip("dispose"), $(this).closest(".card").remove()
                })
            }
    ...
    $(document).ready(function () {
        $("#checkAll").change(function () {
            ...
            }) : $(".checkbox").each(function () { this.checked = !1, $(this).parent().parent().parent().parent().removeClass("selected") })
        }), $(".checkbox").click(function () {
            var e; $(this).is(":checked") ? (e = 0, $(".checkbox").each(function () { this.checked || (e = 1) }), 0 == e &&
                $("#checkAll").prop("checked", !0)) : $("#checkAll").prop("checked", !1)
        }), $(".items-wrapper").on("click", "input:checkbox", function () { $(this).closest(".single-items").toggleClass("selected", this.checked) }),
        ...
        992 < window.innerWidth && document.querySelectorAll(".nxl-header .header-wrapper .dropdown").forEach(function (e) {
            e.addEventListener("mouseover", function (e) { var n, t = this.querySelector("a[data-bs-toggle]"); null != t && (n = t.nextElementSibling, t.classList.add("show"), n.classList.add("show")) }),
                e.addEventListener("mouseleave", function (e) { var n, t = this.querySelector("a[data-bs-toggle]"); null != t && (n = t.nextElementSibling, t.classList.remove("show"), n.classList.remove("show")) })
        })
    });