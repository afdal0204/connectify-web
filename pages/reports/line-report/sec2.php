...
<body>
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Line Report Section 2</li>
                    </ul>
                </div>
                    ...
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <div class="dropdown filter-dropdown">
                                <a class="btn btn-md btn-light-brand" data-bs-toggle="modal" data-bs-target="#sec2FilterModal" data-bs-offset="0, 10" data-bs-auto-close="outside">
                                    <i class="feather-filter me-2"></i>
                                    <span>Filter</span>
                                </a>
                            </div>
                            <a href="javascript:void(0);" class="btn btn-md btn-primary" data-bs-toggle="modal" data-bs-target="#createSec2Modal">
                    ...
                    <div class="col-xxl-12">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Line Report Section 2</h5>
                            ...
                            <div class="card-body custom-card-action p-2 m-2">
                                <div class="table-responsive">
                                    <div id="alertLineReportSec2"></div>
    ...
    <!-- add -->
    <div class="modal fade" id="createSec2Modal" tabindex="-1" aria-labelledby="createSec2ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 35rem;">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title" id="createSec2ModalLabel">Create New Report</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="lineReportSec2" class="row g-3">
                        <div class="col-md-6">
    ...
    <!-- delete -->
    <div class="modal fade" id="deleteModalSec2" tabindex="-1" aria-labelledby="deleteModalSec2Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalSec2Label">Confirm Delete</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="btnConfirmDeleteSec2">Delete</button>
                </div>
            </div>
        </div>
    </div>
       ...
       function showSuccessToast(message) {
        ...
        $(document).ready(function() {
            const lineReportTable = $('#lineReportTable').DataTable({
                ...
                ajax: {
                    url: '/connectify-web/controllers/LineReportController.php?type=sec2',
                    type: 'GET',
                    data: function(d){
            ...
            function showAlert(title, message, type) {
                ...
                $('#alertLineReportSec2').html(alertHtml);
