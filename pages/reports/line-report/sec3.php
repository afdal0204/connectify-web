...
<body>
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Line Report Section 3</li>
                    </ul>
                </div>
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action p-2 m-2">
                                <div class="table-responsive">
                                    <div id="alertLineReportSec3"></div>
        ...
        <div class="modal-dialog modal-lg" style="width: 35rem;">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="createSec3ModalLabel">Create New Report</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="lineReportSec3" class="row g-3">
                        <div class="col-md-6">
    ...
    <!-- delete -->
    <div class="modal fade" id="deleteModalSec3" tabindex="-1" aria-labelledby="deleteModalSec3Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalSec3Label">Confirm Delete</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="btnConfirmDeleteSec3">Delete</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
                        ...
                        render: function(data, type, row) {
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-1">
                                <a href="#" class="btn btn-sm btn-danger btn-delete-server"
                                    ...
                                    data-bs-target="#deleteModalSec3">
            ...
            $('#btnConfirmDeleteSec3').on('click', function() {
            ...
            function showAlert(title, message, type) {
                ...
                $('#alertLineReportSec3').html(alertHtml);
